...
def compareSisterClades():
    ...
    for rep in range(1,101):
        ...
        with open('SIM_TREE_N1/missing_10_'+str(rep)+'.n1.sister_clades') as f:
            for line in f:
        ...
        with open('SIM_TREE_N2/missing_10_'+str(rep)+'.n2.sister_clades') as f:
            for line in f:
                if (line.strip()).endswith(':'):
                    myStrain = line.strip()[:-1]
        ...
        with open('SIM_TREE_N3/missing_10_'+str(rep)+'.n3.sister_clades') as f:
            for line in f:
                if (line.strip()).endswith(':'):
                    myStrain = line.strip()[:-1]
    ...
    open('compareSisNewReal.txt','w').write(myOutString)
